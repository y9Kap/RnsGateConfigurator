...
## [1.2.3] - 2026-03-30
### Changed
- Настройки интерфейса LoraSPI: настройки пинов (GPIO) теперь скрыты в сворачиваемом блоке «Настройки подключения модуля» и отображаются после радио-параметров.
